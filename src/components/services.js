    ...
    return (
      <div className='servicesPage' id='OurApproach'>
        ...
        <div className="serviceOverview">
          <div className="services"><img src={Hypothesis}></img><h4 style={{borderColor: "rgb(47,118,151)"}}>HYPOTHESIS</h4><p>Through creative workshops, we enable organizations identify new hypothesis to grow existing brands or build completely new ones.
            </p></div>
